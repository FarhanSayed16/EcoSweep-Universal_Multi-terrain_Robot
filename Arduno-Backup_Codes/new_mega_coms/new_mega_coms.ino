...
// Obstacle Avoidance Mode (not used in manual mode, but flag kept)
...
void setup() {
  Serial.begin(115200);  // Connected to Raspberry Pi via USB
  pwm.begin();
  pwm.setPWMFreq(50);
  ...
  Serial.println("✅ Arduino Mega Ready. Waiting for commands from Pi...");
}
...
void loop() {
  ...
  // (Optional) Send Distance Back to Pi
  Serial.print("DIST:");
